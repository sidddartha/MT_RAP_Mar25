CLASS lsc_zmt_sid_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zmt_sid_travel IMPLEMENTATION.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES: t_entity_create TYPE TABLE FOR CREATE zmt_sid_travel,
           t_entity_update TYPE TABLE FOR UPDATE zmt_sid_travel,
           t_entity_rep    TYPE TABLE FOR REPORTED zmt_sid_travel,
           t_entity_err    TYPE TABLE FOR FAILED zmt_sid_travel.

    METHODS precheck_sid_reuse
      IMPORTING
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF zmt_sid_travel IN LOCAL MODE
        ENTITY travel
    ...
    LOOP AT lt_travel INTO DATA(ls_travel).
      ...
      IF ( ls_travel-OverallStatus = 'X' ).
        ...
        AUTHORITY-CHECK OBJECT 'ZMTSID_MGR'
        ID 'ACTVT' FIELD '03'.
        IF sy-subrc = 0.
          lv_auth = abap_true.
        ENDIF.
  ...
  METHOD earlynumbering_create.
    DATA: entity        TYPE STRUCTURE FOR CREATE zmt_sid_travel,
...
*        CATCH cx_number_ranges.
  ...
  METHOD copyTravel.
    DATA: travels       TYPE TABLE FOR CREATE zmt_sid_travel\\Travel,
          bookings_cba  TYPE TABLE FOR CREATE zmt_sid_travel\\Travel\_Booking,
          booksuppl_cba TYPE TABLE FOR CREATE zmt_sid_travel\\Booking\_BookingSupplement.
    ...
    MODIFY ENTITIES OF zmt_sid_travel IN LOCAL MODE
        ENTITY travel
