CLASS zsid_aoc_data_builder DEFINITION
 PUBLIC
 FINAL
 CREATE PUBLIC .
 PUBLIC SECTION.
...
ENDCLASS.
CLASS zsid_aoc_data_builder IMPLEMENTATION.
...
*        output =
 ...
 METHOD fill_master_data.
   data : lt_bp type table of zsid_aoc_bpa,
          lt_prod type table of zsid_aoc_product.
   append value #(
  ...
  append value #(
   ...
   append value #(
                   ...
                   to lt_prod.
    insert zsid_aoc_bpa from table @lt_bp.
    insert zsid_aoc_product from table @lt_prod.
 ENDMETHOD.
 METHOD fill_transaction_data.
   data : o_rand type REF TO cl_abap_random_int,
          ...
          lv_ord_id type zsid_aoc_dte_id,
          lt_so type table of zsid_aoc_sd_hdr,
          lt_so_i type table of zsid_aoc_so_item.
   ...
   select * from zsid_aoc_bpa into table @data(lt_bpa).
   select * from zsid_aoc_product into table @data(lt_prod).
   do 50 times.
       ...
       enddo.
   enddo.
   insert zsid_aoc_sd_hdr from table @lt_so.
   insert zsid_aoc_so_item from table @lt_so_i.
 ENDMETHOD.
 METHOD flush.
   delete from : zsid_aoc_bpa, zsid_aoc_product, zsid_aoc_sd_hdr, zsid_aoc_so_item.
 ENDMETHOD.
ENDCLASS.
